...
function AddEmployee(props) {
  ...
  return (
    <div>
      <button onClick={handleShow} className="block m-3 mx-auto bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">+ Add Employee</button>
      ...
      >
        ...
        onClick={handleClose}>Close</button>
          ...
          onClick={handleClose}
          form='editmodal'>Add Employee</button>
        </Modal.Footer>
      </Modal>
    </div>
  );
